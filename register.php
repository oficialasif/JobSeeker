                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex justify-content-between mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:48%; border-radius: 30px; font-weight:600;" />
                      <a href="home.php" class="btn btn-secondary btn-lg my-2 py-3" style="width:48%; border-radius: 30px; font-weight:600;">Home</a>
                    </div>
                  </form>

                  <p align="center">I already have an account <a href="loginpage.php" class="text-warning" style="font-weight:600; text-decoration:none;">Login</a></p>
                </div>
